...
import pbr.version
version_info = pbr.version.VersionInfo('RPCO')
...
htmlhelp_basename = 'RPCO-ReleaseNotes'
...
latex_documents = [
    ('index', 'RPCOReleaseNotes.tex', u'RPCO Release Notes Documentation',
     u'RPCO Developers', 'manual'),
]
...
man_pages = [
    ('index', 'RPCOreleasenotes', u'RPCO Release Notes Documentation',
     [u'RPCO Developers'], 1)
]
...
texinfo_documents = [
    ('index', 'RPCOReleaseNotes', u'RPCO Release Notes Documentation',
     u'RPCO Developers', 'RPCOReleaseNotes',
